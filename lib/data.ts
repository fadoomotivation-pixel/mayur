export const site = {
  ...
  email: 'info@mayuraerocity.com',
  address: 'Site: Near Dholera International Airport, Dholera SIR, Gujarat',
  whatsappMessage:
    'Hi! I am interested in Mayur Aerocity projects in Dholera Smart City. Please share current prices and plot availability.',
};

export const stats = [
  { value: '₹91,000 Cr', label: 'Tata Semiconductor Fab in Dholera' },
  { value: '8+', label: 'Projects Delivered in Dholera' },
...
export const whyDholera = [
  {
    ...
    text: "Dholera is a Gujarat Government notified Special Investment Region under the Delhi–Mumbai Industrial Corridor (DMIC) — India's first and largest greenfield smart city.",
  },
  {
    icon: 'Cpu',
    title: '₹91,000 Cr Semiconductor Hub',
    text: "Tata Electronics' mega semiconductor fabrication plant anchors Dholera's industrial ecosystem, drawing massive housing demand.",
  },
  {
    icon: 'Plane',
    title: 'International Airport',
    text: 'Dholera International Airport is in advanced construction, designed for both cargo and passenger operations — a direct catalyst for land appreciation.',
  },
  {
    icon: 'Route',
    title: 'Expressway Connectivity',
    text: 'The 109 km, 4-lane Ahmedabad–Dholera Expressway cuts travel time to under an hour, with high-speed rail links planned.',
  },
];
...
export const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. Every Mayur project is NA (Non-Agricultural), NOC-approved, title clear and plan passed. Sales are completed only through a registered sale deed in your name.',
  },
  {

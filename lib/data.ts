...
export const projects = [
  {
    ...
    amenities: [
      ...
      { icon: 'Home', label: 'Modern Clubhouse' },
      { icon: 'TreePine', label: 'Tree Plantations' },
      { icon: 'Zap', label: 'Power Supply' },
      { icon: 'Droplets', label: 'Water Supply' },
      { icon: 'PipetteIcon', label: 'Underground Drainage' },
      { icon: 'Route', label: 'Internal CC Roads' },
      { icon: 'Fence', label: 'Boundary Wall' },
    ],
    startingPrice: 'On Request',
    totalPlots: '90',
    plotRange: '132–655 sq yd',
    accent: '#f26522',
  ...
  },
  {
    ...
    amenities: [
      ...
      { icon: 'ShieldCheck', label: 'Gated Community' },
      { icon: 'Route', label: 'CC Roads' },
      { icon: 'Lightbulb', label: 'Street Lighting' },
      { icon: 'Zap', label: '24/7 Power Supply' },
      { icon: 'Droplets', label: 'Water Supply' },
    ],
    startingPrice: '₹9,750/sq yd',
    totalPlots: '259',
    plotRange: '125.84–377.46 sq yd',
    accent: '#3b82f6',
    desc: 'Strategically located near the upcoming Dholera International Airport, Mayur Aerocity II is designed for investors seeking high appreciation. Features 259 premium residential plots with world-class amenities including a clubhouse, swimming pool, and gymnasium.',
  },
  {
    name: 'Mayur Park III',
    slug: 'mayur-park-3',
    ...
    amenities: [
      { icon: 'ShieldCheck', label: 'Gated Entry & Security' },
      { icon: 'Home', label: 'Clubhouse' },
      { icon: 'Zap', label: 'Electricity & Street Lights' },
      { icon: 'Droplets', label: 'Water Supply Network' },
      { icon: 'Fence', label: 'Boundary Walls' },
      { icon: 'Route', label: 'Paver Block Roads' },
      { icon: 'TreePine', label: 'Landscaped Park' },
    ],
    startingPrice: 'On Request',
    totalPlots: '259',
    plotRange: '134–458 sq yd',
    accent: '#e8c774',
    desc: 'Mayur Park III is a premium residential project located in Valinda, Dholera Smart City. Featuring 259 well-planned plots with excellent internal infrastructure, landscaped parks, and a clubhouse.',
  },
  {
    ...
    amenities: [
      { icon: 'ShieldCheck', label: 'Gated Community' },
      { icon: 'Home', label: 'Clubhouse' },
      { icon: 'Trees', label: 'Forest Theme Landscaping' },
      { icon: 'TreePine', label: 'Lush Green Spaces' },
      { icon: 'Zap', label: 'Power Supply' },
      { icon: 'Droplets', label: 'Water Supply' },
      { icon: 'Route', label: 'CC Roads' },
      { icon: 'Fence', label: 'Boundary Wall' },
    ...
    accent: '#22c55e',
    desc: 'Mayur Forest Villa is a thoughtfully planned residential project offering premium villa plots amidst lush greenery. Enjoy a serene forest-themed lifestyle with modern amenities.',
  },
  {
    ...
    size: 'Large-format plots · 130–830 sq yd',
    minSize: '200',
    status: 'Ongoing',
    ...
    amenities: [
      { icon: 'CircleDot', label: 'Mini-Golf Course' },
      { icon: 'Home', label: 'Grand Clubhouse' },
      { icon: 'Waves', label: 'Swimming Pool & Sun Deck' },
      { icon: 'Dumbbell', label: 'Gymnasium & Fitness Zone' },
      { icon: 'Trophy', label: 'Sports Zone' },
      { icon: 'Footprints', label: 'Jogging Track' },
      { icon: 'PartyPopper', label: 'Event Lawn & Amphitheatre' },
      { icon: 'ShoppingBag', label: 'Commercial Complex' },
      { icon: 'ShieldCheck', label: '24/7 Gated Security' },
      { icon: 'TreePine', label: 'Landscaped Gardens' },
      { icon: 'Route', label: 'CC Roads & Utilities' },
    ],
    startingPrice: 'On Request',
    totalPlots: '',
    plotRange: '130–830 sq yd',
    accent: '#f59e0b',
    desc: 'Mayur Greenz Courtyard is a distinguished enclave of luxury villas inspired by the grace of Roman architecture. Features an exclusive mini-golf course, grand clubhouse with swimming pool, and a commercial complex.',
  },
  {
  ...
  },
  {
    ...
    amenities: [
      ...
      { icon: 'Zap', label: 'Power Supply' },
      { icon: 'Droplets', label: 'Water Lines' },
      { icon: 'Route', label: 'Internal Roads' },
      { icon: 'Fence', label: 'Boundary Wall' },
      { icon: 'Truck', label: 'Heavy Vehicle Access' },
    ],
    startingPrice: 'On Request',
    totalPlots: '',
    plotRange: 'Multiple sizes',
    accent: '#64748b',
    desc: 'Located in Dholera Smart City, India\'s emerging modern manufacturing hub, this industrial plot project offers a strategic opportunity for manufacturers and logistics businesses.',
  }
];

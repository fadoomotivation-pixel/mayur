...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#f9fafb] overflow-hidden selection:bg-[#000] selection:text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 text-center">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="flex flex-col items-center">
            ...
            <motion.h1 variants={fadeUp} className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter mb-6 text-gray-900">
              Mayur <span className="text-blue-600">Aerocity II</span>
            </motion.h1>
            
            <motion.p variants={fadeUp} className="text-xl md:text-2xl text-gray-600 max-w-2xl mb-10 font-light">
      ...
      <section id="invest" className="py-32 relative bg-[#f9fafb]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div>
              <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-bold tracking-tight mb-6 text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {whyDholera.map((item, i) => {
              ...
              return (
                <div key={i} className="bg-[#f9fafb] p-8 rounded-3xl border border-gray-100 hover:shadow-lg transition-all duration-300 group">
      ...
      <section id="amenities" className="py-32 bg-white border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6 text-gray-900">Designed for <span className="text-blue-600">Tomorrow.</span></h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">A premium gated community equipped with world-class infrastructure.</p>
          </div>
      ...
      {/* FAQS */}
      <section id="faqs" className="py-32 relative bg-[#f9fafb]">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold tracking-tight mb-4 text-gray-900">Frequently Asked Questions</h2>
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white border border-gray-200 shadow-sm rounded-2xl overflow-hidden transition-colors hover:border-gray-300">
                ...
                >
                  <span className="font-semibold text-lg pr-8 text-gray-900">{faq.q}</span>
      ...
      <section id="contact" className="py-32 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-[#f9fafb] rounded-[2.5rem] p-8 md:p-16 border border-gray-200 shadow-xl text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-blue-50/50" />
            
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 text-gray-900">Secure your piece of the future.</h2>
              <p className="text-gray-600 mb-10 max-w-xl mx-auto text-lg">Leave your details and our investment experts will contact you with the complete project brochure and pricing.</p>
              ...
              <p className="text-sm font-medium text-gray-500 mt-6">
                Or call directly: <a href={`tel:${site.phone}`} className="text-gray-900 hover:text-blue-600">{site.phone}</a> | <a href={`tel:${site.phoneAlt}`} className="text-gray-900 hover:text-blue-600">{site.phoneAlt}</a>
              </p>
            </div>
          </div>
        </div>
